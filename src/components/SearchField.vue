<template lang="html">
  <div v-click-outside="close" class='search-field'>
    <input class="form-control" v-on:keyup.enter="pickFirstResult()" v-on:keyup.esc="emptyResults()" @input="update" v-model="searchText" type='text' placeholder="Search addresses, transaction hash and bundle hash" />
